...
const DropDown = (favoriteCities: any) => {
  ...
  return (
    <div className="origin-top-right right-30  absolute mt-10 w-48 rounded-md h-48 overflow-y-scroll no-scrollbar shadow-lg bg-white ring-1 ring-black ring-opacity-5">
